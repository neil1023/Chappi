...
var wit = require('botkit-middleware-witai')({
    token: "PMPGCFGWMSBFW7WY2IV5PQULFPSCQK67",
});
...
controller.hears(['hello', 'hi'], 'message_received', wit.hears, function(bot, message) {

	bot.reply(message, '(Reply from Wit)');
...
controller.hears(['how many patients'], 'message_received', 
	function(bot, message) {
		bot.reply(message,
			':robot_face: Hello my friend');
});
